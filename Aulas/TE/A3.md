...
$\small{Z(p; T = 100 ^{\circ}C) = 1,00 \:–\: 2,77 \times 10^{-3} \,p \:+\: 1,42 \times 10^{-5} \,p^2 \:-\: 3,56 \times 10^{-7} \,p^3 \:+\: 2,80 \times 10^{-9} \,p^4 \:-\: 8,23 \times 10^{-12} \,p^5 \:+\: 8,40 \times 10^{-15} \,p^6}$
$\small{Z(p; T = 75 ^{\circ}C) = 1,00 \:–\: 2,77 \times 10^{-3} \,p \:+\: 1,42 \times 10^{-5} \,p^2 \:-\: 3,56 \times 10^{-7} \,p^3 \:+\: 2,80 \times 10^{-9} \,p^4 \:-\: 8,23 \times 10^{-12} \,p^5 \:+\: 8,40 \times 10^{-15} \,p^6}$
