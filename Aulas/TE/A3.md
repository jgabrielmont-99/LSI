...
<div class="mathbox-wrapper">
  <div class="mathbox">
    $$\color{black} Z = 1 + B_{2p}(T) \cdot p + B_{3p}(T) \cdot p^2 + B_{4p}(T) \cdot p^3 + \cdots \\
    \color{red} Z = 1 + B_{2V}(T) \cdot \frac {1}{\bar V} + B_{3V}(T) \cdot \frac {1}{\bar V}^2 + B_{4V}(T) \cdot \frac {1}{\bar V}^3 + \cdots \\
    \color{blue} Z = 1 + B_{2}(T) \cdot \rho + B_{3}(T) \cdot \rho^2 + B_{4}(T) \cdot \rho^3 + \cdots $$
  </div>
  <div class="eq-numbers">
