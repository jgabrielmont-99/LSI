...
<div class="mathbox-wrapper">
  <div class="mathbox">
    ...
    \boldsymbol{\overline{\sum_i^N {\vec F}_i \cdot {\vec r}_i} = \overline{\sum_i^N {\vec F}_i^p \cdot {\vec r}_i} + \overline{\sum_i^N {\vec F}_i^{pot} \cdot {\vec r}_i}}$$
  </div>
  <div class="eq-numbers">
    <span style="font-weight: bold;">E2.1</span>
    <span style="color: red;">E2.2</span>
  </div>
</div>
