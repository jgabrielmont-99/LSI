...
<p class="jt">
e $\langle k \rangle$ é a energia cinética média de uma única partícula. Aqui, assumimos que a energia cinética total será igual a $N \langle k \rangle$, pois as partículas que compõe o gás são idênticas. Podemos imaginar que $\langle k \rangle$ será tão maior quanto maior for a velocidade media da partícula. Assim, podemos ver que a idéia de que a temperatura está atrelada à velocidade das partículas possui raiz na termodinâmica estatística – ramo da termodinâmica que relaciona propriedades macroscópicas de sistemas com médias de propriedades de sistemas compostos por átomos e moléculas.
</p>
...
<p class="jt">
pois o produto do número de Avogadro (NA) pela constante de Boltzmann é igual à constante dos gases ideais (R).
</p>
<p class="jt">
