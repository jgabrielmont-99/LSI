...
<p class="jt">
É possível demonstrar que o termo da esquerda é igual a menos duas vezes a energia cinética média total do sistema ($\angle K \rangle$), enquanto que o termo de colisão com as paredes do recipente é igual a menos três vezes o produto da pressão pelo volume do sistema. Como todos os termos  são iguais a zero em <span style="color: blue; font-style: italic;">E2.1</span>, então o segundo termo do lado direito é igual a zero como um todo. Então:
</p>
