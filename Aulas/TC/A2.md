...
<div class="toolbox">
  ...
  <div class="toolbox-header">
    ...
    <p class="toolbox-subtitle">Simululador de Gás Ideal Bidimensional</p>
  </div>
  
  <div class="toolbox-content">
    <div class="interactive-area" id="esferas-tool">
      
      <div class="jsbox-control-panel">
        <div class="jsbox-controls-grid" style="grid-template-columns: 2fr 3fr auto; gap: 15px;">
          
          <div>
            <div class="jsbox-col-title sys">Parâmetros</div>
            <div class="jsbox-input-row">
              <label>N:</label>
              <input type="number" id="inp-n1" class="jsbox-input" value="150" step="10">
            </div>
            <div class="jsbox-input-row">
              <label>T:</label>
            ...
            <div class="jsbox-input-row">
              <label>m:</label>
              <input type="number" id="inp-m1" class="jsbox-input" value="20" step="1">
            </div>
            <div class="jsbox-input-row">
              <label>L:</label>
          ...
          <div style="display: flex; flex-direction: column; justify-conten: center;">
            <button id="btn-run" class="jsbox-btn jsbox-btn-primary" style="padding: 15px 25px; font-weight: bold; font-size: 1rem;">
              CALCULAR SIMULAÇÃO
            </button>
          </div>
...
<div class="toolbox" id="gas-ideal-tool">
    <div class="toolbox-header">
        <h2 class="toolbox-title">Laboratório Virtual</h2>
        <p class="toolbox-subtitle">Equação de Estado para o Gás Ideal</p>
    </div>
    ...
    <div class="toolbox-content">
        <div class="jsbox-control-panel">
            <div class="jsbox-controls-grid">
                <div>
                    <div class="jsbox-col-title sys">Configuração dos Eixos</div>
                    <div class="jsbox-input-row">
                        <label>Eixo X:</label>
                        <select class="axis-x jsbox-input">
                    ...
                    <div class="jsbox-input-row">
                        <label>Eixo Y:</label>
                        <select class="axis-y jsbox-input">
                ...
                <div>
                    <div class="jsbox-col-title opt">Opções de Exibição</div>
                    <div class="jsbox-input-row">
                        <label>Nº de Curvas:</label>
                        <select class="num-curves jsbox-input">
                    ...
                    <div class="jsbox-input-row">
                        ...
                        <div style="display:flex; gap:2px; width:50%">
                            <input type="number" class="xmin jsbox-input" value="1" style="width:100%">
                            <input type="number" class="xmax jsbox-input" value="50" style="width:100%">
                        </div>
                    </div>
                    <div class="jsbox-input-row">
                        <label>Y min/max:</label>
                        <div style="display:flex; gap:2px; width:50%">
                            <input type="number" class="ymin jsbox-input" value="0" style="width:100%"> 
                            <input type="number" class="ymax jsbox-input" value="25" style="width:100%">
                        </div>
                    </div>
                </div>
            </div> <div id="param-container" style="margin-top: 15px;"></div>

            <div style="margin-top: 15px;">
                <button class="generate-btn jsbox-btn jsbox-btn-primary">ATUALIZAR GRÁFICO</button>
                <button id="autoscale-btn" class="jsbox-btn jsbox-btn-success">AUTO-ESCALA</button>
            </div>
        </div> <div class="jsbox-card">
            <div class="jsbox-card-header">Gráfico de Estado</div>
            <div class="jsbox-card-body">
                <div class="graph-canvas" style="height: 500px;">
