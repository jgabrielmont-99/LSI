...
<p class="jt">
Voltando ao problema original, podemos finalmente combinar o resultado da energia cinética média total (<a href="#TC2.1" style="color: blue; font-style: italic;">TC2.3</a>) com a equação obtida pelo teorema do virial (<a href="#TC2.1" style="color: blue; font-style: italic;">TC2.2</a>):
</p>
