...
<div id="esferas-tool" style="font-family: sans-serif; color: #333; max-width: 1000px; margin: 0 auto; background: #fff; padding: 20px; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08);">
    
    <div class="jsbox-controls-grid" style="display: grid; grid-template-columns: 1fr 2fr auto; gap: 20px; background: #f8f9fa; padding: 20px; border-radius: 10px; margin-bottom: 20px; align-items: start;">
        
        <div style="display: flex; flex-direction: column; gap: 10px;">
          <div class="jsbox-col-title" style="font-weight: bold; color: #003366; border-bottom: 2px solid #003366; margin-bottom: 5px;">Parâmetros</div>
          <div style="display: flex; align-items: center; justify-content: space-between;">
            <label>N:</label>
            <input type="number" id="inp-n1" style="width: 70px; padding: 4px; border: 1px solid #ccc; border-radius: 4px;" value="150" step="10">
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between;">
            <label>T:</label>
            <input type="number" id="inp-T" style="width: 70px; padding: 4px; border: 1px solid #ccc; border-radius: 4px;" value="300" step="10">
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between;">
            <label>m:</label>
            <input type="number" id="inp-m1" style="width: 70px; padding: 4px; border: 1px solid #ccc; border-radius: 4px;" value="50" step="1">
          </div>
          <div style="display: flex; align-items: center; justify-content: space-between;">
            <label>L:</label>
            <input type="number" id="inp-edge" style="width: 70px; padding: 4px; border: 1px solid #ccc; border-radius: 4px;" value="70" step="5">
          </div>
        </div>

        <div style="background: #fdfdfd; border-radius: 8px; border: 1px solid #eee; padding: 10px; min-height: 120px;">
          <div class="jsbox-col-title" style="color: #666; font-size: 0.9em; border-bottom: 1px solid #eee; margin-bottom: 8px; display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: bold;">Últimos Resultados</span>
        ...
        <div style="display: flex; flex-direction: column; justify-content: center; height: 100%;">
          <button id="btn-run" style="background: #003366; color: white; border: none; padding: 15px 25px; border-radius: 8px; cursor: pointer; font-weight: bold; font-size: 1em; transition: background 0.2s;">
            CALCULAR SIMULAÇÃO
          </button>
        </div>

        <div style="display: none;">
          <input type="number" id="inp-steps" value="40000">
