...
<div class="toolbox" id="gas-ideal-tool">
    <div class="toolbox-header">
        ...
        <p class="toolbox-subtitle">Configure os eixos e parâmetros fixos para comparar as curvas.</p>
    </div>

    <div class="toolbox-content">
        <div class="interactive-area" style="font-size: 0.9rem;">
            <div style="display: flex; gap: 15px; margin-bottom: 15px;">
                <div style="flex: 1;">
                    <label>Eixo X:</label>
                    <select class="axis-x"><option value="V">Volume (V)</option><option value="T">Temperatura (T)</option><option value="P">Pressão (P)</option><option value="n">n (mol)</option></select>
                </div>
                <div style="flex: 1;">
                    <label>Eixo Y:</label>
                    <select class="axis-y"><option value="P" selected>Pressão (P)</option><option value="V">Volume (V)</option><option value="T">Temperatura (T)</option><option value="n">n (mol)</option></select>
                </div>
                <div style="flex: 1;">
                    <label>Curvas:</label>
                    <select class="num-curves"><option value="1">1</option><option value="2">2</option><option value="3">3</option></select>
                </div>
            </div>

            <div style="background: #f9f9f9; padding: 10px; border-radius: 8px; margin-bottom: 15px;">
                <p style="font-weight: bold; margin-bottom: 5px;">Parâmetros das Curvas (P, V, T, n):</p>
                <table style="width: 100%; text-align: center;">
                    ...
                    <tr><td>P (bar)</td><td><input type="number" class="p-0" value="1.0" step="0.1"></td><td><input type="number" class="p-1" value="1.0" step="0.1"></td><td><input type="number" class="p-2" value="1.0" step="0.1"></td></tr>
                    <tr><td>V (L)</td><td><input type="number" class="v-0" value="10.0" step="1"></td><td><input type="number" class="v-1" value="10.0" step="1"></td><td><input type="number" class="v-2" value="10.0" step="1"></td></tr>
                    <tr><td>T (K)</td><td><input type="number" class="t-0" value="300" step="10"></td><td><input type="number" class="t-1" value="450" step="10"></td><td><input type="number" class="t-2" value="600" step="10"></td></tr>
                    <tr><td>n (mol)</td><td><input type="number" class="n-0" value="1.0" step="0.1"></td><td><input type="number" class="n-1" value="1.0" step="0.1"></td><td><input type="number" class="n-2" value="1.0" step="0.1"></td></tr>
                </table>
            </div>

            <div style="display: flex; gap: 15px; margin-bottom: 15px;">
                <div><label>X min/max:</label><br><input type="number" class="xmin" value="1" style="width:60px"> - <input type="number" class="xmax" value="50" style="width:60px"></div>
                <div><label>Y min/max:</label><br><input type="number" class="ymin" value="0" style="width:60px"> - <input type="number" class="ymax" value="25" style="width:60px"></div>
            </div>

            <button class="generate-btn" style="width: 100%; padding: 10px; background: #003366; color: white; border: none; border-radius: 5px; cursor: pointer; font-weight: bold;">
                ATUALIZAR GRÁFICO
            </button>
        </div>
